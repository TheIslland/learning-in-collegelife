...
while_expr
    ...
    | DO dowhile_block WHILE '(' condition_expr ')' ';' -> ^(DOWHILE condition_expr dowhile_block)
    ;

dowhile_block: block -> ^(BLOCK block);

/*
switch_expr
    : SWITCH '('! op_expr ')'! case_expr -> ^(SWITCH op_expr case_expr)
    ;
